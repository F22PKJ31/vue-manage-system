    ...
    <div class="table">
        <div class="crumbs">
            <el-breadcrumb separator="/">
                <el-breadcrumb-item><i class="el-icon-lx-cascades"></i> 博客评论管理</el-breadcrumb-item>
            </el-breadcrumb>
        </div>
        <div class="container">
    ...
    export default {
        ...
        methods: {
            ...
            getData() {
                ...
                this.axiosProxy.getBlogCommentList(queryParams).then(response => {
            ...
            deleteRow() {
                ...
                this.axiosProxy.deleteComment(queryParams).then(response => {
                    if (!response.data) {
